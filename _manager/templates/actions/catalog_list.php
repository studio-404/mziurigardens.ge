...
?>
					<ul id="page" class="fix left" style="width:720px; float: left;">
						<li><a href="<?php echo ahref(array($route[0], 'show', $route[2]), $params) ?>"><img src="_manager/img/prev2.png" width="5" height="5" alt=""  class="arrow" /></a></li>
						<li><a href="<?php echo ahref(array($route[0], 'show', $route[2]), $params) ?>"><img src="_manager/img/prev.png" width="5" height="5" alt=""  class="arrow" /></a></li>
<?php
...
?>
						<li><a href="<?php echo ahref(array($route[0], 'show', $route[2]), $params) ?>"><img src="_manager/img/next.png" width="5" height="5" alt="" class="arrow" /></a></li>
						<li><a href="<?php echo ahref(array($route[0], 'show', $route[2]), $params) ?>"><img src="_manager/img/next2.png" width="5" height="5" alt="" class="arrow" /></a></li>
					</ul>
					<a href="<?php echo ahref(array($route[0], 'add', $route[2])) ;?>" class="button br" id="addcategory" style="float: right"><?php echo a("addcatalogitem");?></a>
				</div>
			</div>
